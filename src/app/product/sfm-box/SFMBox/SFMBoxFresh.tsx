      ...
      {freshness.length > 0 && (
        <div className="space-y-2">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b">
                  <th className="text-left p-2">Freshness Score</th>
                  <th className="text-left p-2">IoT</th>
                  <th className="text-left p-2">e-eye</th>
                  <th className="text-left p-2">e-nose</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="p-2">{iotResult.iotScore.toFixed(2)}</td>
                  <td className="p-2">{imageProc.imgScore.toFixed(2)}</td>
                  <td className="p-2">{e_nose.noseScore.toFixed(2)}</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="text-sm">
            Date, Time:{" "}
            {freshness[freshness.length - 1].time.split(" ")[0].substring(0, 15)},{" "}
